...
-- Creating tabs
local Tabs = {
  profile = Window:AddTab({ Title = "Player", Icon = "" }),
    Supper = Window:AddTab({ Title = "Farm", Icon = "" }),
    Sell = Window:AddTab({ Title = "Sell", Icon = "" }),
    Setup = Window:AddTab({ Title = "• Auto Settings", Icon = "" }),
...
Tabs.profile:AddButton({
        ...
        Description = "",
        Callback = function()
        setclipboard("https://discord.gg/JjcRVjQj")
        end
    })

    local section = Tabs.Supper:AddSection("Fish")

  local DropdownShake = Tabs.Supper:AddDropdown("DropdownShake", {
        Title = "Select Mode",
        Description = "",
        Values = {"Phantom", "Mouse"},
        Multi = false,
        Default = 1,
    })
    ...
    local Slider = Tabs.Supper:AddSlider("Slider", {
        Title = "Shake Delay",
        Description = "",
        Default = 2,
        Min = 0.2,
    ...
    local autoReelCastShakeT = Tabs.Supper:AddToggle("autoReelCastShakeT", {Title = "Auto Farm Fishing", Default = false })
    ...
    local AntiAfk3 = Tabs.Setup:AddToggle("AntiAfk3", {Title = "Anti Ban Afk", Description = "", Default = true })
    AntiAfk3:OnChanged(function(Value)
        AntiAfk = AntiAfk3.Value
        AntiAfk2()
    end)

    local section = Tabs.Sell:AddSection("Sell Fish")

    local AutoSellF = Tabs.Sell:AddToggle("AutoSellF", {Title = "Auto Sell Fish", Default = false })
    AutoSellF:OnChanged(function()
        AutoSell = AutoSellF.Value
        AutoSellz()
    end)

    local SliderSell = Tabs.Supper:AddSlider("SliderSell", {
        Title = "Selling Fish Every Second",
        Description = "",
        Default = 60,
        Min = 1,
        Max = 600,
    ...
    Tabs.Supper:AddButton({
        Title = "Auto Sell Each One Fish",
        Description = "",
        Callback = function()
...
local FishAreas = {
    ...
    local DropdownArea = Tabs.Teleports:AddDropdown("DropdownArea", {
        Title = "Teleport Area There Are Fish",
    ...
    local ToggleAntiDrown = Tabs.Setup:AddToggle("ToggleAntiDrown", {Title = "Infinity Oxygen", Default = false })
    ...
    local WhiteGui5 = Tabs.Setup:AddToggle("WhiteGui5", {Title = "White Screen", Default = false })
    ...
    local ToggleWalkspeed = Tabs.Player:AddToggle("Walk Speed", {Title = "Walk Speed", Default = false })
    ...
    local InputJump = Tabs.Player:AddInput("Power", {
        Title = "Power",
        Default = "50",
        Placeholder = "",
        Numeric = true,
